...
class AffiliatesControllerTest < ActionController::TestCase
  ...
  test "should create affiliate" do
    assert_difference('Affiliate.count') do
      post :create, affiliate: { active: @affiliate.active, club_id: @affiliate.club_id, start: @affiliate.start, user_id: @affiliate.user_id }
    end
  ...
  test "should update affiliate" do
    patch :update, id: @affiliate, affiliate: { active: @affiliate.active, club_id: @affiliate.club_id, start: @affiliate.start, user_id: @affiliate.user_id }
    assert_redirected_to affiliate_path(assigns(:affiliate))
  end
